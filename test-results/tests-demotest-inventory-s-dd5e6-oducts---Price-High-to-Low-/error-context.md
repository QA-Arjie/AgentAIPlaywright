...
- Name: tests\demotest\inventory-scenarios.spec.ts >> Inventory Scenarios >> 1.5 Sort Products - Price (High to Low)
- Location: tests\demotest\inventory-scenarios.spec.ts:64:7
