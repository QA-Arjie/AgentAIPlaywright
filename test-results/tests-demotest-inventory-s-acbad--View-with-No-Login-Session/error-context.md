...
- Name: tests\demotest\inventory-scenarios.spec.ts >> Inventory Scenarios >> 3.1 View with No Login Session
- Location: tests\demotest\inventory-scenarios.spec.ts:105:7
