...
- Name: tests\demotest\inventory-scenarios.spec.ts >> Inventory Scenarios >> 1.3 Sort Products - Name (Z to A)
- Location: tests\demotest\inventory-scenarios.spec.ts:39:7
